                    ...
                    <div class="mt-5">
                        <div class="relative">
                            <input id="images" name="images" type="file" placeholder="Imatges"
                                class="file-input file-input-bordered max-w-xs border-b w-full border-gray-300 py-1 focus:border-b-2 focus:border-blue-700 transition-colors focus:outline-none peer bg-inherit" multiple/>
                        </div>
                    </div>
                    <div class="mt-5">
                    <div class="relative">
                        ...
                        <input id="cam" name="cam" type="button" value="Obrir càmera"
                            class="file-input file-input-bordered max-w-xs border-b w-full border-gray-300 py-1 focus:border-b-2 focus:border-blue-700 transition-colors focus:outline-none peer bg-inherit"
