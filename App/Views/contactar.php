...
<body>
    ...
    <div class="bg-white border border-slate-200 grid grid-cols-6 gap-2 rounded-xl p-2 text-sm w-full max-w-md  m-auto mt-10 ">
        <h1 class="text-center text-gray-400 text-xl font-bold col-span-6">Enviar missatge</h1>
        <input type="mail" placeholder="Email" class="bg-slate-100 text-slate-600 h-10 placeholder:text-slate-600 placeholder:opacity-50 border border-slate-200 col-span-6 resize-none outline-none rounded-lg p-2 duration-300 focus:border-slate-600">
        <textarea placeholder="El teu missatge..." class="bg-slate-100 text-slate-600 h-28 placeholder:text-slate-600 placeholder:opacity-50 border border-slate-200 col-span-6 resize-none outline-none rounded-lg p-2 duration-300 focus:border-slate-600"></textarea>
