...
<body>
    ...
    <form action="/uploadPhoto" method="post">
        <!-- Agrega el atributo 'action' y 'method' -->
        ...
        <div class="flex flex-wrap justify-center items-center">
            ...
            <div class="flex flex-col justify-center items-center mx-4 my-4">
                ...
                <img class="w-40 h-56 rounded-md" src="<?= $photo["url"] ?>" alt="">
                <input type="radio" name="selectedPhoto" value="<?= $photo["id"] ?>" class="radio mt-5">
            </div>
            <?php endforeach; ?>
        </div>
        <div class="mt-5 flex items-center justify-center">
            <button for="<?= $photo["id"] ?>" type="submit"
        ...
        <p class="text-center text-md mb-5 mt-5 hover:text-blue-800 transition duration-300"><a href="/contactar">Si hi
                ha qualsevol error, posa't en contacte amb nosaltres!</a></p>
    </form>
