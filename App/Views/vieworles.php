        ...
        <div class="card w-96 bg-base-100 shadow-xl m-4 border-2 transform transition-transform hover:scale-105">
            ...
            <div class="ml-auto mr-1 mt-1">
                <svg width="32px" height="32px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g id="" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
                        <g id="" sketch:type="MSArtboardGroup" fill="#e63946">
                            <path
            ...
            <div class="card-body">
                ...
                <div class="card-actions justify-center">
                    ...
                    <a href="/eliminar-orla?id=<?= $orla['orla_id'] ?>" name="eliminar">
                        <button class="btn bg-neutral-300 w-16">
                    ...
                    <a href="/descarregar-orla/<?= $orla['orla_id'] ?>/A4">
                        <button class="btn bg-neutral-300 w-16" title="Descarregar Orla">
                        ...
                        <span style="display: none;">Descarregar</span>
        ...
        <div class="card w-96 h-96 bg-base-100 shadow-xl m-4 border-2 transform transition-transform hover:scale-105">
            ...
            <div class="card-body">
                <a href="/create-new-orla" class="mt-20 ml-24 ">
                    <svg width="160px" height="160px" viewBox="0 0 32 32" version="1.1"
                    ...
                    <span style="display: none;">Afegir Orla</span>
                </a>
