...
<body class="bg-gray-100 h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded shadow-md max-w-md w-full">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Nova Contrasenya</h2>
        <form class="space-y-4" action="/newpass" method="post">
            <div>
                <label for="email" class="block text-sm font-medium text-gray-600">Correu Electrònic</label>
                <input id="email" name="email" type="email" class="mt-1 p-2 w-full border rounded-md focus:outline-none focus:border-blue-500">
            </div>
            <div>
                <label for="password" class="block text-sm font-medium text-gray-600">Contrasenya</label>
