            ...
            <div class="card-body items-center text-center">
                <div class="tooltip avatar" data-tip="Editar foto">
                    <div class="w-24 rounded-full">
                        <a href="/photo"><img src="../img/3.jpeg" alt="foto de perfil"/></a>
                    </div>
                </div>
...
<input type="text" id="group" title="grup" name="group" class="input bg-transparent rounded-sm outline-none border-b-black hover:bg-white hover:border-bs-blue focus:bg-white focus:outline-none transition-colors duration-300" placeholder="Grup" value="<?= isset($group) ? $group : '' ?>">
