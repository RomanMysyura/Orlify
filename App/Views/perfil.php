...
<body class="bg-gray-200">
    ...
    <input type="hidden" name="id" value="<?= $user['id'] ?>">
        ...
        <div  class="tooltip avatar" data-tip="Editar foto">
            ...
            <input type="text" id="name" name="name" class="input bg-transparent rounded-sm outline-none border-b-black hover:bg-white hover:border-bs-blue focus:bg-white focus:outline-none transition-colors duration-300" placeholder="Nom" value="<?= $user['name'] ?>">

            <label for="cognom">Cognom:</label>
            <input type="text" id="surname" name="surname" class="input bg-transparent rounded-sm outline-none border-b-black hover:bg-white hover:border-bs-blue focus:bg-white focus:outline-none transition-colors duration-300" placeholder="Cognom" value="<?= $user['surname'] ?>">
