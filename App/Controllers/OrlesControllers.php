 ...
 *
 * @param mixed $request   Objecte que conté les dades de la sol·licitud HTTP.
 * @param mixed $response  Objecte de resposta HTTP.
 * @param mixed $container Objecte de contenidor de dependències.
 *
 * @return mixed Objecte de resposta amb les dades actualitzades del panell de control.
 */
public function eliminarOrlaPanel($request, $response, $container)
{
    // Obtenir l'ID de l'orla des de la URL
    $orla_id = $_GET['id'];
    
    // Obtenció dels models necessaris des del contenidor de dependències
    $OrlaModel = $container["\App\Models\Orles"];
    $usersModel = $container["\App\Models\usersPDO"];
    ...
    // Obtenció de dades per actualitzar el panell de control
    $users = $usersModel->getAllUsers();
    ...
    // Configurar la resposta amb les dades actualitzades
    ...
    // Retornar l'objecte de resposta
    return $response;
}
